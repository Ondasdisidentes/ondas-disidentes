...
import "./ondas.css";
import { PROGRAMAS_EJEMPLO } from "@/lib/programas";
...
export default function Home() {
  ...
  const programaActual = PROGRAMAS_EJEMPLO[currentPrograma];
          ...
          <div className={"frame"}>
            ...
            <section className={cx("win", activeWin === "inicio" && "on")}>
              <header className={"mast"}>
                <h1 className={"fix"}>
                  <span className={"hm"}>On</span>das <span className={"hm"}>Dis</span>identes
                </h1>
              ...
              <section className={"hero"}>
                <div className={"hero__left"}>
                  <img className={"hero__tz"} src="/images/hero-doodle.webp" alt="" aria-hidden="true" />
                  <p className={cx("slogan", "fix")}>
                    Las frecue<span className={"hm"}>ncias</span> también son un bien co
                    <span className={"hm"}>mún</span>.{" "}
                    <span className={"u"}>
                      Noso<span className={"hm"}>trxs</span> las dispu<span className={"hm"}>tamos</span>.
                    </span>
                  </p>
                ...
                <div className={"hero__right"}>
                  <div className={cx("hero__stage", "halftone")}>
                    <img className={"hero__main"} src="/images/megafono-principal.webp" alt="Radialista en la consola de transmisión" />
                  </div>
                  <div className={"hero__strip"}>
                    <span className={cx("hero__cap", "fix")}>
                      Escucha <span className={"hm"}>sus</span> voces
                    </span>
                  </div>
                </div>
              </section>
